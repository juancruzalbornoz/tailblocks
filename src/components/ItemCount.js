    ...
    return (
        <div class="flex-col" style={{ padding: '1em' }}>
            ...
            <div class="flex space-x-4 " style={{ padding: '1em' }}>
                ...
                <button onClick={reiniciar} class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">/</button>
                <button onClick={onAdd} class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">{num > 0 ? `Agregar ${num} al ` : `Elegi tu cantidad`}</button>
